...
class ExhibitionCoreDataController:NSObject,ExhibitionDatabaseProtocol, NSFetchedResultsControllerDelegate{
    ...
    func addPlant(name: String, yearDiscovered: Int, family: String, scientificName: String) -> Plant {
    ...
    func createDefaultExhibits(){
        ...
        let titanArum = addPlant(name: "Titan arum", yearDiscovered: 1879, family: "Araceae", scientificName: "Amorphophallus titanum")
